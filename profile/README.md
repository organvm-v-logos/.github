...
**Building in public — essays, process, and thought leadership**

</div>

---

Essays, marginalia, process documentation, building in public, RSS/newsletter, audience engagement

## Repositories

<!-- This section will be populated after repos are deployed to this org. -->
<!-- Use: gh repo list organvm-v-logos --json name,description --template '...' -->
...
<sub>ORGAN V: Logos &mdash; part of the eight-organ creative-institutional system</sub>
